...
public class FileManager {
     ...
     */
    public List<File> getFilesByExtension(final String fileExtension) {

        final File folder = new File(INBOX_PATH);
        final File[] arrOfFiles = folder.listFiles();
     ...
     */
    public List<String> readFile(final String filename, final String encoding)
        throws IOException {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public List<String> readFile(final String filename, final String encoding, final String stopper)
        throws IOException {
