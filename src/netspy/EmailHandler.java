...
public class EmailHandler {
     ...
     * @return
     */
    private Email extractEmailProperties(final Email email) {

        for (final String line : email.getLines()) {
     ...
     */
    public void setMailContainer(final EmailContainer mailContainer) {
    ...
    public void putMailsIntoQuarantine() {
        ...
        for (final Email email : this.getMailContainer().getMails()) {
     ...
     * @param email the email
     */
    private void putMailIntoQuarantine(final Email email) {
     ...
     */
    private Email checkAgainstBlacklist(final Email email)
        throws IOException {
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public List<String> getMailContent(final File file)
        throws IOException {
     ...
     */
    public void setEmlFiles(final List<File> emlFiles) {
